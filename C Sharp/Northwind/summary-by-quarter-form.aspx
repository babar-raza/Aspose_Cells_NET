<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="summary-by-quarter-form.aspx.cs"
    Inherits="Aspose.Cells.Demos.Northwind.SummaryByQuarterForm" MasterPageFile="~/tpl/Demo.Master"
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <tr>
                ...
                <td class="demos-heading-bg" style="width: 100%">
                    <h2 class="demos-heading-bg">
                        Summary of Sales by Quarter - Aspose.Cells</h2>
                </td>
                <td valign="top" style="width: 19px">
    ...
    <div style="text-align: left; font-family: Arial; font-size: small;" class="componentDescriptionTxt">
        <p>
            This online demo illustrates how to create a well formatted Summary by Quarter report
        ...
        <p>
            The demo generates a summary report showing sales from multiple years for each quarter.
            ADO.NET is used to retrieve the data from the Orders table of Northwind database,
        ...
        <p>
            Click Process to see how example prints summary report showing sales from multiple
            years for each quarter.
        </p>
        <p>
            Please download the
