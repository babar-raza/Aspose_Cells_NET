...
{
	/// <summary>
	/// Summary description for HighLowClose.
	/// </summary>
	public class HighLowClose : System.Web.UI.Page
	{
		...
		private void btnProcess_Click(object sender, System.EventArgs e)
		{
            ...
            workbook.Save(HttpContext.Current.Response, "HighLowClose." + ddlFileVersion.SelectedItem.Value.ToLower(), ContentDisposition.Attachment, new XlsSaveOptions(saveFormat));
		...
		private void CreateStaticData(Workbook workbook)
		{
			...
			cells["B1"].PutValue("High");
			cells["C1"].PutValue("Low");
			cells["D1"].PutValue("Close");
			
            //Put values for Row 1
			cells["A2"].PutValue("Microsoft");
			cells["B2"].PutValue(27.20);
			cells["C2"].PutValue(23.49);
			cells["D2"].PutValue(25.45);

            //Put values for Row 2
			cells["A3"].PutValue("Mutual Fund 1");
			cells["B3"].PutValue(25.03);
			cells["C3"].PutValue(19.55);
			cells["D3"].PutValue(23.05);

            //Put values for Row 3
			cells["A4"].PutValue("Mutual Fund 2");
			cells["B4"].PutValue(19.05);
			cells["C4"].PutValue(15.12);
			cells["D4"].PutValue(17.32);
		}
		...
		private void CreateStaticReport(Workbook workbook)
		{
			...
			sheet.Name = "HighLowClose";
			
            //Set Gridlines invisible
            sheet.IsGridlinesVisible = false;

            //Create chart of type StockHighLowClose
			int chartIndex = sheet.Charts.Add(ChartType.StockHighLowClose,5,1,29,10);

            //initialize Charts 
			Chart chart = sheet.Charts[chartIndex];

            //Set chart Properties for Nseries
