...
{
	/// <summary>
	/// Summary description for PyramidColumn.
	/// </summary>
	public class PyramidColumn : System.Web.UI.Page
	{
		...
		private void btnProcess_Click(object sender, System.EventArgs e)
		{
            ...
            workbook.Save(HttpContext.Current.Response, "PyramidColumn." + ddlFileVersion.SelectedItem.Value.ToLower(), ContentDisposition.Attachment, new XlsSaveOptions(saveFormat));
		...
		private void CreateStaticReport(Workbook workbook)
		{
            ...
            {
                case "0":
                    chartIndex = sheet.Charts.Add(ChartType.Pyramid, 1, 3, 25, 12);
                    break;
                case "1":
                    chartIndex = sheet.Charts.Add(ChartType.PyramidStacked, 1, 3, 25, 12);
                    break;
            }
