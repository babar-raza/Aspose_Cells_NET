...
{
	/// <summary>
	/// Summary description for ColumnChart.
	/// </summary>
	public class ColumnChart : System.Web.UI.Page
	{
		...
		private void btnProcess_Click(object sender, System.EventArgs e)
		{
            ...
            workbook.Save(HttpContext.Current.Response, "3DChart." + ddlFileVersion.SelectedItem.Value.ToLower(), ContentDisposition.Attachment, new XlsSaveOptions(saveFormat));
		...
		{
            //get index of newly added worlsheet
			int sheetIndex = workbook.Worksheets.Add(SheetType.Chart);

            //Initialize worksheet against supplied index
			Worksheet sheet = workbook.Worksheets[sheetIndex];

			//Set the name of worksheet
			sheet.Name = "BarColumn Chart";
			
			int chartIndex = 0;

            //Add chart to collection depending on the selected values of ChartTypeList
			switch ( ChartTypeList.SelectedItem.Text )
			{
				case "Cylinder":					
					chartIndex = sheet.Charts.Add(ChartType.Cylinder,0,0,0,0);					
					break;
				case "Cone":					
					chartIndex = sheet.Charts.Add(ChartType.Cone,0,0,0,0);			
					break;
				case "Pyramid":
					chartIndex = sheet.Charts.Add(ChartType.Pyramid,0,0,0,0);
					break;
			}			
			...
			chart.Walls.ForegroundColor = Color.Ivory;
			chart.Floor.ForegroundColor = Color.LightYellow;			
			chart.Elevation = 15;
