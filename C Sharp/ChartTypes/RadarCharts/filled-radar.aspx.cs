...
{
	/// <summary>
	/// Summary description for FilledRadar.
	/// </summary>
	public class FilledRadar : System.Web.UI.Page
	{
		...
		private void btnProcess_Click(object sender, System.EventArgs e)
		{
            ...
            workbook.Save(HttpContext.Current.Response, "FilledRadar." + ddlFileVersion.SelectedItem.Value.ToLower(), ContentDisposition.Attachment, new XlsSaveOptions(saveFormat));	
		...
		private void CreateStaticReport(Workbook workbook)
		{
            ...
            //Create chart of type RadarFilled
			int chartIndex = sheet.Charts.Add(ChartType.RadarFilled,1,1,25,10);						
			Chart chart = sheet.Charts[chartIndex];

			//Set properties of chart like border visibility
