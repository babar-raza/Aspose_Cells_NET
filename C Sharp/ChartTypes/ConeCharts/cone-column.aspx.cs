...
{
	/// <summary>
	/// Summary description for ConeColumn.
	/// </summary>
	public class ConeColumn : System.Web.UI.Page
	{
        ...
        protected void btnProcess_Click(object sender, EventArgs e)
        {
            ...
            workbook.Save(HttpContext.Current.Response, "ConeColumn." + ddlFileVersion.SelectedItem.Value.ToLower(), ContentDisposition.Attachment, new XlsSaveOptions(saveFormat));
		...
		private void CreateStaticReport(Workbook workbook)
		{
			...
			//Set the name of worksheet
			sheet.Name = "Cone Column";

            //Set Worksheet's Gridlines Invisible
			sheet.IsGridlinesVisible = false;

            //Create chart depending on th eselected value in ChartTypeList
			int chartIndex = 0;
			switch ( ChartTypeList.SelectedItem.Value)
			{
				case "0": 			
					chartIndex = sheet.Charts.Add(ChartType.Cone,1,3,25,12);					
					break;
				case "1":			
					chartIndex = sheet.Charts.Add(ChartType.ConeStacked,1,3,25,12);			
					break;			
			}				
            ...
            //Set Nseries CategoryData from COlumn A
