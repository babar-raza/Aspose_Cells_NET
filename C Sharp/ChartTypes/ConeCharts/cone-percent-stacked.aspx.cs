...
{
	/// <summary>
	/// Summary description for ConePercentStacked.
	/// </summary>
	public class ConePercentStacked : System.Web.UI.Page
	{
        ...
        protected void btnProcess_Click(object sender, EventArgs e)
        {
            ...
            workbook.Save(HttpContext.Current.Response, "ConePercentStacked." + ddlFileVersion.SelectedItem.Value.ToLower(), ContentDisposition.Attachment, new XlsSaveOptions(saveFormat));
		...
		private void CreateStaticReport(Workbook workbook)
		{
            ...
            //Create chart depending upon selected value in ChartTypeList
			int chartIndex = 0;			
			switch ( ChartTypeList.SelectedItem.Text ) 
			{
				case "Cone100PercentStacked":
					...
					break;
				case "ConicalBar100PercentStacked":
            ...
            //loop over the Nseries and Name them as values in rows of First COlumn
