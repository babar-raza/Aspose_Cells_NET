...
{
	/// <summary>
	/// Summary description for ConeBar.
	/// </summary>
	public class ConeBar : System.Web.UI.Page
	{
        ...
        protected void btnProcess_Click(object sender, EventArgs e)
        {
            ...
            workbook.Save(HttpContext.Current.Response, "ConeBar." + ddlFileVersion.SelectedItem.Value.ToLower(), ContentDisposition.Attachment, new XlsSaveOptions(saveFormat));
		...
		private void CreateStaticReport(Workbook workbook)
		{
			...
			//Create chart depending on the selected values from ChartType Dropdown on UI
			int chartIndex = 0;
			switch ( ChartTypeList.SelectedItem.Text)
			{
				case "ConicalBar": 			
					chartIndex = sheet.Charts.Add(ChartType.ConicalBar,1,1,25,10);					
					break;
				case "ConicalBarStacked":				
					chartIndex = sheet.Charts.Add(ChartType.ConicalBarStacked,1,1,25,10);			
					break;			
			}				
