...
{
	/// <summary>
	/// Summary description for CylinderPercentStacked.
	/// </summary>
	public class CylinderPercentStacked : System.Web.UI.Page
	{
        ...
        protected void btnProcess_Click(object sender, EventArgs e)
        {
            ...
            workbook.Save(HttpContext.Current.Response, "CylinderPercentStacked." + ddlFileVersion.SelectedItem.Value.ToLower(), ContentDisposition.Attachment, new XlsSaveOptions(saveFormat));
		...
		private void CreateStaticReport(Workbook workbook)
		{
            ...
            //Create chart depending on selected item from ChartTypeList
			int chartIndex = 0;			
			switch ( ChartTypeList.SelectedItem.Text ) 
			{
				case "Cylinder100PercentStacked":
					...
					break;
				case "CylindericalBar100PercentStacked":
