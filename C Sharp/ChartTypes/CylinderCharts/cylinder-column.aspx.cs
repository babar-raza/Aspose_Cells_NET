...
{
	/// <summary>
	/// Summary description for CylinderColumn.
	/// </summary>
	public class CylinderColumn : System.Web.UI.Page
	{
        ...
        protected void btnProcess_Click(object sender, EventArgs e)
        {
            ...
            workbook.Save(HttpContext.Current.Response, "CylinderColumn." + ddlFileVersion.SelectedItem.Value.ToLower(), ContentDisposition.Attachment, new XlsSaveOptions(saveFormat));
		...
		private void CreateStaticReport(Workbook workbook)
		{
            ...
            //Set Sheet's GridLines invisible
			sheet.IsGridlinesVisible = false;

            //Create chart depending on the selected value in ChartTypeList
			int chartIndex = 0;
			switch ( ChartTypeList.SelectedItem.Value)
			{
				case "0": 			
					chartIndex = sheet.Charts.Add(ChartType.Cylinder,1,3,25,12);					
					break;
				case "1":				
					chartIndex = sheet.Charts.Add(ChartType.CylinderStacked,1,3,25,12);			
					break;			
			}				
