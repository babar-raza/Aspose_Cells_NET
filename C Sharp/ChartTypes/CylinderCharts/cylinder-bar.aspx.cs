...
{
	/// <summary>
	/// Summary description for CylinderBar.
	/// </summary>
	public class CylinderBar : System.Web.UI.Page
	{
        ...
        protected void btnProcess_Click(object sender, EventArgs e)
        {
            ...
            workbook.Save(HttpContext.Current.Response, "CylinderBar." + ddlFileVersion.SelectedItem.Value.ToLower(), ContentDisposition.Attachment, new XlsSaveOptions(saveFormat));
		...
		{
            //get Index of newly added Workseet
			int sheetIndex = workbook.Worksheets.Add();

            //initialize worksheet at given Index
			...
			switch ( ChartTypeList.SelectedItem.Text)
			{
				case "CylindericalBar": 			
					chartIndex = sheet.Charts.Add(ChartType.CylindricalBar, 1, 1, 25, 10);					
					break;
				case "CylindericalBarStacked":				
					chartIndex = sheet.Charts.Add(ChartType.CylindricalBarStacked, 1, 1, 25, 10);			
					break;			
			}				
