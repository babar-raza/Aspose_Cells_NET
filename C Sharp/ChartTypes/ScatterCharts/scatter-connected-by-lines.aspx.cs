...
{
	/// <summary>
	/// Summary description for ScatterConnectedByLines.
	/// </summary>
	public class ScatterConnectedByLines : System.Web.UI.Page
	{
		...
		{    
			...
			this.ID = "ScatterConnectedByLines";
		...
		private void btnProcess_Click(object sender, System.EventArgs e)
		{
            ...
            workbook.Save(HttpContext.Current.Response, "ScatterConnected." + ddlFileVersion.SelectedItem.Value.ToLower(), ContentDisposition.Attachment, new XlsSaveOptions(saveFormat));	
		...
		{		
            //get index for newly added Worksheet
            ...
            //Create chart depending on ChartTypeList's SelectedItem
			int chartIndex = 0;
			switch ( ChartTypeList.SelectedItem.Text )
			{	
				case "ScatterConnectedByCurvesWithDataMarker":
					chartIndex = sheet.Charts.Add(ChartType.ScatterConnectedByCurvesWithDataMarker,1,1,25,10);
					break;
				case "ScatterConnectedByCurvesWithoutDataMarker":
					chartIndex = sheet.Charts.Add(ChartType.ScatterConnectedByCurvesWithoutDataMarker,1,1,25,10);
					break;
				case "ScatterConnectedByLinesWithDataMarker":
					chartIndex = sheet.Charts.Add(ChartType.ScatterConnectedByLinesWithDataMarker,1,1,25,10);
					break;
				case "ScatterConnectedByLinesWithoutDataMarker":
					chartIndex = sheet.Charts.Add(ChartType.ScatterConnectedByLinesWithoutDataMarker,1,1,25,10);
					break;
			}			
            ...
            //Loop over NSeries and Set name
