...
Namespace Aspose.Cells.Demos
	...
	Partial Public Class Pivot_Chart
		...
		Public Sub CreateStaticReport()
			...
			'Adding a new sheet
			Dim sheet2 As Worksheet = workbook.Worksheets(workbook.Worksheets.Add(SheetType.Chart))

			'Naming the sheet
			sheet2.Name = "PivotChart"

			'Adding a column chart       
			Dim index2 As Integer = sheet2.Charts.Add(ChartType.Column, 0, 5, 28, 16)
