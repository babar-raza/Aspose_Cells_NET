<%@ Page Language="vb" MasterPageFile="~/tpl/Demo.Master" AutoEventWireup="true"
	CodeBehind="designer.aspx.vb" Inherits="Aspose.Cells.Demos.SmartMarker.designer"
	Title="Designer spreadsheet with Smart Markers - Aspose.Cells Demos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
			...
			<tr>
				...
				<td class="demos-heading-bg" style="width: 100%">
					<h2 class="demos-heading-bg">
						Designer spreadsheet with Smart Markers - Aspose.Cells</h2>
				</td>
				<td valign="top" style="width: 19px">
	...
	<div style="text-align: left; font-family: Arial; font-size: small;" class="componentDescriptionTxt">
		...
		<p>
			Click on Process button to open the file into MS Excel or save it to your disk.
		</p>
		<p>
			Please download the
