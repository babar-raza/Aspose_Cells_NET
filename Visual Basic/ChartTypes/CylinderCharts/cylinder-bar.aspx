<%@ Page Language="vb" Codebehind="cylinder-bar.aspx.vb" AutoEventWireup="false"
	Inherits="Aspose.Cells.Demos.CylinderBar" MasterPageFile="~/tpl/Demo.Master"
	Title="Cylinder Bar - Aspose.Cells Demos" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div style="text-align: left; font-family: Arial; font-size: small;" class="componentDescriptionTxt">
		<p>
			This online demo exhibits how to create a Cylinder Bar chart in a worksheet using
			<a href="http://www.aspose.com/categories/file-format-components/aspose.cells-for-.net-and-java/default.aspx">
				Aspose.Cells</a> for .NET.</p>
		<p>
			The bars in these types of chart are represented by cylindrical shapes. You may
		...
		<p>
			The demo creates a cylinder bar chart titled number of employees into the second
			...
			a drop down list which represents the chart type (CylindericalBar and CylindericalBarStacked)
					...
					<tr>
						...
						<td>
							<asp:DropDownList runat="server" ID="ChartTypeList">
								...
								<asp:ListItem Value="1">CylindericalBarStacked</asp:ListItem>
							</asp:DropDownList>
						</td>
					</tr>
					<tr>
