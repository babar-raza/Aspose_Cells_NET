<%@ Page Language="vb" Codebehind="cylinder-percent-stacked.aspx.vb" AutoEventWireup="false"
	Inherits="Aspose.Cells.Demos.CylinderPercentStacked" MasterPageFile="~/tpl/Demo.Master"
	Title="Cylinder Percent Stacked - Aspose.Cells Demos" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
		...
		<tr>
			...
			<td class="demos-heading-bg" style="height: 41; width: 100%; font-family: Arial;
				...
				<h2 class="demos-heading-bg">
					Cylinder Percent Stacked - Aspose.Cells</h2>
			</td>
			<td valign="top" style="height: 41; width: 19">
	...
	<div style="text-align: left; font-family: Arial; font-size: small;" class="componentDescriptionTxt">
		<p>
			This online demo demonstrates how to create a <b>Cylinder 100% Stacked Bar/Column chart</b>
		...
		<p>
			The demo creates a cylinder 100% stacked chart titled Product contribution to total
		...
		<p>
			...
			a cylinder 100% stacked or 100% stacked bar chart.</p>
	</div>
	<table class="genericTable" style="font-family: Arial; font-size: small;">
		<tr>
			<td valign="top" align="right">
				<img alt="" src="../../Image/CylinderPercentStacked.jpg" /></td>
					...
					<tr>
						...
						<td>
							<asp:DropDownList runat="server" ID="ChartTypeList">
								<asp:ListItem Value="0">Cylinder100PercentStacked</asp:ListItem>
								<asp:ListItem Value="1">CylindericalBar100PercentStacked</asp:ListItem>
							</asp:DropDownList></td>
					</tr>
					<tr>
						<td>
