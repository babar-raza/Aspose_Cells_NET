<%@ Page Language="vb" Codebehind="pyramid-column-3d.aspx.vb" AutoEventWireup="false"
	Inherits="Aspose.Cells.Demos.PyramidColumn3D" MasterPageFile="~/tpl/Demo.Master"
	Title="Pyramid Column 3D - Aspose.Cells Demos" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
		...
		<tr>
			...
			<td class="demos-heading-bg" style="height: 41; width: 100%; font-family: Arial;
				...
				<h2 class="demos-heading-bg">
					Pyramid Column 3D - Aspose.Cells</h2>
			</td>
			<td valign="top" style="height: 41; width: 19">
	...
	<div style="text-align: left; font-family: Arial; font-size: small;" class="componentDescriptionTxt">
		<p>
			This online demo exhibits how to create a <b>Pyramid 3-D Column chart</b> in a worksheet
			using <a href="http://www.aspose.com/categories/file-format-components/aspose.cells-for-.net-and-java/default.aspx">
				Aspose.Cells</a> for .NET.</p>
		<p>
			The 3-D columns in these types of chart are represented by pyramid shapes. Aspose.Cells
			...
			named Pyramid Column3D. The first column represents the category data (Year spanned
			over 1996 - 2006) where as the second column represents the number of employees
			which denotes values in the chart.
		</p>
		<p>
			The demo creates a pyramid 3-D column chart titled number of employees into the
