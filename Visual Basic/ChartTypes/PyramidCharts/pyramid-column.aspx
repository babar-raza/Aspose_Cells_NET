<%@ Page Language="vb" Codebehind="pyramid-column.aspx.vb" AutoEventWireup="false"
	Inherits="Aspose.Cells.Demos.PyramidColumn" MasterPageFile="~/tpl/Demo.Master"
	Title="Pyramid Column - Aspose.Cells Demos" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
		...
		<tr>
			...
			<td class="demos-heading-bg" style="height: 41; width: 100%; font-family: Arial;
				...
				<h2 class="demos-heading-bg">
					Pyramid Column - Aspose.Cells</h2>
			</td>
			<td valign="top" style="height: 41; width: 19">
	...
	<div style="text-align: left; font-family: Arial; font-size: small;" class="componentDescriptionTxt">
		<p>
			This online demo exhibits how to create a <b>Pyramid Column chart</b> in a worksheet
			using <a href="http://www.aspose.com/categories/file-format-components/aspose.cells-for-.net-and-java/default.aspx">
				Aspose.Cells</a> for .NET.</p>
		<p>
			The columns in these types of chart are represented by pyramid shapes. You may create
			...
			two columns (A and B) of the first worksheet named Pyramid Column. The first column
		...
		<p>
			The demo creates a pyramid column chart representing number of employees into the
			...
			the chart type (<b>Pyramid</b> and <b>PyramidStacked</b>) and a command button labeled
			<b>Create Report</b> to create the chart based on your selection from the drop down
			list. The chart is created with a particular elevation and rotation angle, a specified
			depth and gap width in percentage b/w clusters as well. You can either open the
			resultant excel file into <b>Excel</b> or save directly to your disk.</p>
		<p>
			Click <b>Create Report</b> to see how demo can set the appearance properties of
			a pyramid column chart.</p>
	</div>
	<table class="genericTable" style="font-family: Arial; font-size: small;">
		<tr>
			<td valign="top" align="right">
				<img alt="" src="../../Image/PyramidColumn.jpg" /></td>
					...
					<tr>
						...
						<td>
							<asp:DropDownList runat="server" ID="ChartTypeList">
								<asp:ListItem Value="0">Pyramid</asp:ListItem>
								<asp:ListItem Value="1">PyramidStacked</asp:ListItem>
							</asp:DropDownList></td>
					</tr>
					<tr>
						<td>
