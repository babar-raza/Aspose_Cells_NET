...
Namespace Aspose.Cells.Demos
	''' <summary>
	''' Summary description for BarofPie.
	''' </summary>
	Public Class BarofPie
...
'			Me.Load += New System.EventHandler(Me.Page_Load);
		...
		Private Sub btnProcess_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcess.Click
			...
			workbook.Save(HttpContext.Current.Response, "BarofPie." & ddlFileVersion.SelectedItem.Value.ToLower(), ContentDisposition.Attachment, New XlsSaveOptions(saveFormat))
		...
		Private Sub CreateStaticReport(ByVal workbook As Workbook)
			...
			'Create chart of Type PieBar
			Dim chartIndex As Integer = 0
			chartIndex = sheet.Charts.Add(ChartType.PieBar,1,3,25,12)
			...
			For i As Integer = 0 To chart.NSeries.Count - 1
				'Set Nseriese DataLabels to show Value
				chart.NSeries(i).DataLabels.ShowValue = True

				'Assign DataLabels 
				Dim dataLabels As Charts.DataLabels = chart.NSeries(i).DataLabels
