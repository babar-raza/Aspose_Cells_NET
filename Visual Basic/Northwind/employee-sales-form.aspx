<%@ Page Language="vb" AutoEventWireup="true" CodeBehind="employee-sales-form.aspx.vb"
	Inherits="Aspose.Cells.Demos.Northwind.EmployeeSalesForm" MasterPageFile="~/tpl/Demo.Master"
	Title="Employee Sales by Country - Apose.Cells Demos" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
			...
			<tr>
				...
				<td class="demos-heading-bg" style="width: 100%">
					<h2 class="demos-heading-bg">
						Employee Sales by Country - Aspose.Cells</h2>
				</td>
				<td valign="top" style="width: 19px">
	...
	<div style="text-align: left; font-family: Arial; font-size: small;" class="componentDescriptionTxt">
		<p>
			This online demo illustrates how to create a well formatted Employee Sales by Country
		...
		<p>
			The demo generates a printed report displaying employee sales grouped by country.
			It also calculates subtotals, grand total and percents of sales. It prints range
			on report and prints message when employee's total reaches a goal. A separate sheet
			is generated per country. ADO.NET is used to retrieve the data from the Employees
		...
		<p>
			Click Process to see how example Prints sales grouped by country and employee, calculates
			subtotals, grand total, percents; prints range on report; prints message when employee's
			total reaches goal; a sheet per country.
		</p>
		<p>
			Please download the
