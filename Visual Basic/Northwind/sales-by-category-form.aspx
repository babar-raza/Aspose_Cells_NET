<%@ Page Language="vb" AutoEventWireup="true" CodeBehind="sales-by-category-form.aspx.vb"
	Inherits="Aspose.Cells.Demos.Northwind.SalesByCategoryForm" MasterPageFile="~/tpl/Demo.Master"
	Title="Sales by Category - Apose.Cells Demos" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
			...
			<tr>
				...
				<td class="demos-heading-bg" style="width: 100%">
					<h2 class="demos-heading-bg">
						Sales By Category - Aspose.Cells</h2>
				</td>
				<td valign="top" style="width: 19px">
	...
	<div style="text-align: left; font-family: Arial; font-size: small;" class="componentDescriptionTxt">
		<p>
			This online demo illustrates how to create a well formatted sub report for <b>Sales
				by Category</b> report using <a href="http://www.aspose.com/categories/file-format-components/aspose.cells-for-.net-and-java/default.aspx">
		...
		<p>
			The demo generates a sub report for Sales by Category. ADO.NET is used to retrieve
		...
		<p>
			Click <b>Process</b> to see how example prints sales for 1994 by category. Output
			document will show sales in a subreport and in a chart on the main report.
		</p>
		<p>
			Please download the
