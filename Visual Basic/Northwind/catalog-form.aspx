<%@ Page Language="vb" AutoEventWireup="true" CodeBehind="catalog-form.aspx.vb" Inherits="Aspose.Cells.Demos.Northwind.CatalogForm"
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div style="text-align: left; font-family: Arial; font-size: small;" class="componentDescriptionTxt">
		<p>
			This online demo illustrates how to create a well formatted Catalog report by using
		...
		<p>
			The demo generates a Catalog of products. It has a two-page report header and uses
			...
			page. ADO.NET is used to retrieve the data from the Products table of Northwind
			database, to generate the report. You can either open the resultant excel file into
			MS Excel or save directly to your disk to check the results.</p>
		<p>
			Click Process to see how example Prints a catalog of products. The document will
			contain two-page report header, photos for each category; the demo starts each category
			on a new page; keeps all records for a category on same page; prints an order form
			in the report footer on a separate page.</p>
		<p>
			Please download the
