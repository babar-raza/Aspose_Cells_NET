<%@ Page Language="vb" AutoEventWireup="true" CodeBehind="products-by-category-form.aspx.vb"
	Inherits="Aspose.Cells.Demos.Northwind.ProductsByCategoryForm" MasterPageFile="~/tpl/Demo.Master"
	Title="Products by Category - Apose.Cells Demos" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
			...
			<tr>
				...
				<td class="demos-heading-bg" style="width: 100%">
					<h2 class="demos-heading-bg">
						Products By Category - Aspose.Cells</h2>
				</td>
				<td valign="top" style="width: 19px">
	...
	<div style="text-align: left; font-family: Arial; font-size: small;" class="componentDescriptionTxt">
		<p>
			This online demo illustrates how to create a well formatted Product by Category
		...
		<p>
			The demo generates a printed report displaying products by category. It has 3 columns
			per page and starts each category in a new column.. ADO.NET is used to retrieve
			the data from the Products and Categories tables of Northwind database, to generate
		...
		<p>
			Click Execute to see how example prints products by category. Output document will
			have 3 columns per page; each category will start in new column.
		</p>
		<p>
			Please download the
