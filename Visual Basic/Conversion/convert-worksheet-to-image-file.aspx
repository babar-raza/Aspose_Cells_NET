<%@ Page Language="vb" MasterPageFile="~/tpl/Demo.Master" AutoEventWireup="true"
	Inherits="Sheet2Image" Title="Convert Worksheet to Image File - Aspose.Cells Demos"
	CodeBehind="convert-worksheet-to-image-file.aspx.vb" %>
			...
			<tr>
				...
				<td class="demos-heading-bg" style="width: 100%">
					<h2 class="demos-heading-bg">
						Convert Worksheet to Image File - Aspose.Cells</h2>
				</td>
				<td valign="top" style="width: 19px">
	...
	<div style="text-align: left; font-family: Arial; font-size: small;" class="componentDescriptionTxt">
		<p>
			This online demo demonstrates the ability of <a href="http://www.aspose.com/categories/file-format-components/aspose.cells-for-.net-and-java/default.aspx">
				Aspose.Cells</a> for .NET to convert a worksheet to image file.</p>
		<p>
			...
			file into your picture viewer or save directly to your disk.</p>
		<p>
			Please download the
